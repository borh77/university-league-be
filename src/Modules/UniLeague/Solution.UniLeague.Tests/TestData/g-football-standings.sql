...
VALUES
    (-1, 1, 'Red Lions FC',    10, 7, 3, 0, 24, 22,  9, NULL, NULL),
    (-1, 2, 'Blue Eagles',     10, 6, 3, 1, 21, 18, 11, NULL, NULL),
    (-1, 3, 'Green Wolves',    10, 3, 3, 4, 12, 14, 18, NULL, NULL),
    (-1, 4, 'Yellow Tigers',   10, 1, 0, 9,  3,  6, 22, NULL, NULL);